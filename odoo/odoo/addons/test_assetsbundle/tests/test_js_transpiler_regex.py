    ...
    def test_correct_ODOO_MODULE_RE(self):
        ...
        for case in cases:
            ...
            if "alias" in case:
                ...
                assert (
                    ODOO_MODULE_RE.match(case).groupdict().get("alias") == "web.test"
            ...
            if "default" in case:
                ...
                assert (
                    ODOO_MODULE_RE.match(case).groupdict().get("default") == "false"
    ...
    def test_incorrect_ODOO_MODULE_RE(self):
        ...
        for case in cases:
            assert not ODOO_MODULE_RE.match(case).groupdict().get("alias"), (
                "URL_RE should fail because of too much spaces but didn't... >%s<"
                % case
            )
