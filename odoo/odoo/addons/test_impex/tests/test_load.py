...
class test_m2m(ImporterCase):
    ...
    def test_xids(self):
        ...
        result = self.import_(
            ["value/id"],
            [
                ["{},{}".format(self.xid(record0), self.xid(record1))],
                ["%s" % self.xid(record3)],
                ["{},{}".format(self.xid(record2), self.xid(record1))],
            ],
        )
        self.assertFalse(result["messages"])
        self.assertEqual(len(result["ids"]), 3)
    ...
    def test_names(self):
        ...
        result = self.import_(
            ["value"],
            [
                ["{},{}".format(name(record1), name(record2))],
                ["{},{},{}".format(name(record0), name(record1), name(record2))],
                ["{},{}".format(name(record0), name(record3))],
            ],
        )
        self.assertFalse(result["messages"])
        self.assertEqual(len(result["ids"]), 3)
