    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _render(self, template, values=None, **options):
        ...
        compile_options = dict(
            self.env.context, dev_mode="qweb" in tools.config["dev_mode"]
        )
        ...
        for fragment in fragments:
            for row in fragment.iterfind(".//tr[@data-pagebreak]"):
                ...
                table.addprevious(
                    html.Element("div", attrib={"style": "page-break-after: always"})
                )
    ...
    def _compile_expr(self, expr, raise_on_missing=False):
        ...
        namespace_expr = self._compile_expr_tokens(
            tokens,
        ...
        assert_valid_codeobj(
            _SAFE_QWEB_OPCODES, compile(namespace_expr, "<>", "eval"), expr
        )
