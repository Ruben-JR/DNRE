...
class AvatarMixin(models.AbstractModel):
    ...
    avatar_1920 = fields.Image(
        "Avatar", max_width=1920, max_height=1920, compute="_compute_avatar_1920"
    )
    avatar_1024 = fields.Image(
        "Avatar 1024", max_width=1024, max_height=1024, compute="_compute_avatar_1024"
    )
    avatar_512 = fields.Image(
        "Avatar 512", max_width=512, max_height=512, compute="_compute_avatar_512"
    )
    avatar_256 = fields.Image(
        "Avatar 256", max_width=256, max_height=256, compute="_compute_avatar_256"
    )
    avatar_128 = fields.Image(
        "Avatar 128", max_width=128, max_height=128, compute="_compute_avatar_128"
    )
