    ...
    def _check_python_external_dependency(pydep):
        try:
            ...
            try:
                ...
                raise Exception(f"Python library not installed: {pydep}")
            ...
            raise Exception(f"Error finding python library {pydep}")
    ...
    def _check_external_dependencies(terp):
        ...
        for binary in depends.get("bin", []):
            try:
                ...
                raise Exception(f"Unable to find {binary!r} in path")
            ...
            if modules and not any(modules <= closure(module) for module in modules):
                ...
                raise UserError(
                    "\n".join(
                        [msg % category.name]
                        + [
                            "- {} ({})".format(module.shortdesc, labels[module.state])
