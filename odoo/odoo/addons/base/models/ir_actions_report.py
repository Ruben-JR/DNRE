...
class IrActionsReport(models.Model):
    ...
    def _post_pdf(self, save_in_attachment, pdf_content=None, res_ids=None):
        ...
        if len(streams) == 1:
            ...
            try:
                ...
                raise UserError(
                    _("One of the documents you are trying to merge is encrypted")
                )
    ...
    def _raise_on_unreadable_pdfs(self, streams, stream_record):
        ...
        if unreadable_pdfs:
            records = [
                stream_record[s].name for s in unreadable_pdfs if s in stream_record
            ]
            raise UserError(
                _(
    ...
    def _render_qweb_pdf(self, res_ids=None, data=None):
        ...
        (
            ...
            footer,
            specific_paperformat_args,
        ) = self_sudo.with_context(context)._prepare_html(html)
