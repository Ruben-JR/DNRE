    ...
    def test_qweb_recorder(self):
        ...
        expected = [
            ...
            },
            {
                ...
                "query": 0,
            },  # the compiled template method is in cache
            # first pass in the loop: content of the child template
            {
                "view_id": child_template.id,
                "xpath": "/t/span/t[1]",
                "directive": "t-esc='item'",
                "query": 0,
            },
            {
                "view_id": child_template.id,
                "xpath": "/t/span/t[2]",
                "directive": "t-esc='add_one_query()'",
                "query": 1,
            },
            {
                "view_id": template.id,
                "xpath": "/t/t/t[3]",
                "directive": "t-esc='item_value'",
                "query": 0,
            },
            {
                "view_id": template.id,
            ...
            },
            {
                ...
                "directive": "t-call='base.dummy'",
                "query": 0,
            },  # 0 because the template is in cache
            {
                "view_id": child_template.id,
                "xpath": "/t/span/t[1]",
                "directive": "t-esc='item'",
