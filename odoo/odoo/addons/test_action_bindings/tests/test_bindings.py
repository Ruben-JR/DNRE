...
class TestBindingViewFilters(common.TransactionCase):
    def test_act_window(self):
        ...
        list_act = A.fields_view_get(view_type="tree", toolbar=True)["toolbar"][
            "action"
        ]
        self.assertEqual(
        ...
        kanban_act = A.fields_view_get(view_type="kanban", toolbar=True)["toolbar"][
            "action"
        ]
        self.assertEqual(
    ...
    def test_act_record(self):
        ...
        list_act = B.fields_view_get(view_type="tree", toolbar=True)["toolbar"][
            "action"
        ]
        self.assertEqual(
            [a["name"] for a in list_act],
        ...
        kanban_act = B.fields_view_get(view_type="kanban", toolbar=True)["toolbar"][
            "action"
        ]
        self.assertEqual(
            [a["name"] for a in kanban_act],
