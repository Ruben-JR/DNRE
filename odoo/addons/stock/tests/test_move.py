...
class StockMove(TransactionCase):
    ...
    def test_edit_reserved_move_line_8(self):
        ...
        move1._action_done()
        self.assertEqual(
            untracked_move_line.product_qty, 0
        )  # change reservation to 0 for done move
        self.assertEqual(
            tracked_move_line.product_qty, 0
        )  # change reservation to 0 for done move
        self.assertEqual(move1.state, "done")
    ...
    def test_scrap_8(self):
        ...
        pick03_prod01_move = scrap_picking03.move_lines.filtered(
    ...
    def test_edit_done_picking_1(self):
        ...
        self.assertEqual(
            len(picking.move_lines), 1, "One move should exist for the picking."
        )
        self.assertEqual(
        ...
        self.assertTrue(
            ml.move_id in picking.move_lines,
        ...
        self.assertTrue(
            all(move.state == "done" for move in picking.move_lines),
