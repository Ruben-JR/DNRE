...
class TestPickShip(TestStockCommon):
    ...
    def test_mto_moves_extra_qty(self):
        ...
        self.assertEqual(
            move_lines.mapped("procure_method"), ["make_to_order", "make_to_stock"]
        )
    ...
    def test_edit_done_chained_move(self):
        ...
        self.assertEqual(
            picking_pick.move_lines.quantity_done,
            10.0,
            "Wrong quantity_done for pick move",
        )
        self.assertEqual(
            picking_client.move_lines.product_qty,
            10.0,
    ...
    def test_edit_done_chained_move_with_lot(self):
        ...
        self.assertEqual(
            picking_client.move_lines.move_line_ids.lot_id,
            lot1,
    ...
    def test_pick_ship_return(self):
        ...
        """
        self.assertTrue(
            return_ship_picking.move_lines
            in return_pick_picking.move_lines.mapped("move_orig_ids"),
            "The pick return picking's moves should have the ship return picking's moves as origin",
        )

        self.assertTrue(
            return_pick_picking.move_lines
    ...
    def test_pick_pack_ship_return(self):
        ...
        self.assertEqual(
            set(picking_pack.move_lines.move_orig_ids.ids),
            set(picking_pick.move_lines.ids),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            set(picking_ship.move_lines.move_orig_ids.ids),
            set(picking_pack.move_lines.ids),
        )
        self.assertEqual(
            set(picking_ship.move_lines.move_dest_ids.ids),
            set(return_ship_picking.move_lines.ids),
        )

        self.assertEqual(
            set(return_ship_picking.move_lines.move_orig_ids.ids),
            set(picking_ship.move_lines.ids),
        )
        self.assertEqual(
            set(return_ship_picking.move_lines.move_dest_ids.ids),
            set(return_pack_picking.move_lines.ids),
        )
        ...
        self.assertEqual(
            set(return_pack_picking.move_lines.move_dest_ids.ids),
            set(return_pick_picking.move_lines.ids),
        )
    ...
    def test_merge_move_mto_mts(self):
        ...
        self.assertEqual(
            len(picking_client.move_lines), 2, "Moves should not be merged"
        )
    ...
    def test_mto_cancel_move_line(self):
        ...
        self.assertEqual(
            picking_client.move_line_ids.product_uom_qty,
            5,
...
class TestSinglePicking(TestStockCommon):
    ...
    def test_extra_move_1(self):
        ...
        self.assertEqual(
            move1.move_line_ids.product_qty, 0.0
    ...
    def test_extra_move_4(self):
        ...
        self.assertEqual(
            len(delivery.move_lines), 2, "Move should not be merged together"
        )
    ...
    def test_extra_move_5(self):
        ...
        delivery._action_done()
        self.assertEqual(
            delivery.move_lines.product_uom_qty,
            5.95,
    ...
    def test_use_create_lot_use_existing_lot_4(self):
        ...
        with self.assertRaises(UserError):
            self.env["stock.production.lot"].with_context(
    ...
    def test_merge_moves_2(self):
        ...
        self.assertEqual(
            receipt.move_lines.origin.count("MPS"),
            1,
            "Origin not merged together or duplicated",
        )
        self.assertEqual(
            receipt.move_lines.origin.count("PO0001"),
            1,
            "Origin not merged together or duplicated",
        )
    ...
    def test_immediate_transfer(self):
        ...
        picking.action_cancel()
        self.assertEqual(
            picking.move_lines.state,
            "cancel",
            "Stock move should be in a cancel state.",
        )
        self.assertEqual(
            picking.state, "cancel", "Picking should be in a cancel state."
        )
...
class TestStockUOM(TestStockCommon):
    ...
    def test_pickings_transfer_with_different_uom_and_back_orders(self):
        ...
        self.assertEqual(
            back_order_in.move_lines.product_qty,
            91640.00,
    ...
    def test_move_product_with_different_uom(self):
        ...
        self.assertEqual(
            float_compare(
                move_line.product_qty, quant.quantity, precision_digits=precision_digits
            ),
            -1,
        ...
        self.assertTrue(
            float_is_zero(
                move_line.product_qty - quant.reserved_quantity,
...
class TestRoutes(TestStockCommon):
    ...
    def test_replenish_pick_ship_1(self):
        ...
        move_line = last_picking_id.move_lines.search(
            [("product_id", "=", self.product1.id)]
        )
    ...
    def test_mtso_mto(self):
        ...
        for picking in picking_ids:
            ...
            self.assertEqual(
                picking.move_lines.product_uom_qty,
                5,
