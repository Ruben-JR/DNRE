...
class TestPacking(TestPackingCommon):
    ...
    def test_pack_in_receipt_two_step_multi_putaway_02(self):
        ...
        move_form = Form(
            receipt_picking.move_lines, view="stock.view_stock_move_operations"
        )
        ...
        move_form = Form(
            internal_picking.move_lines, view="stock.view_stock_move_operations"
        )
    ...
    def test_pack_in_receipt_two_step_multi_putaway_03(self):
        ...
        move_form = Form(
            receipt_picking.move_lines[0], view="stock.view_stock_move_operations"
        )
        with move_form.move_line_ids.edit(0) as line:
            line.qty_done = 50
            line.result_package_id = package_02
        move_form.save()
        move_form = Form(
            receipt_picking.move_lines[1], view="stock.view_stock_move_operations"
        )
        with move_form.move_line_ids.edit(0) as line:
            line.qty_done = 50
            line.result_package_id = package_02
