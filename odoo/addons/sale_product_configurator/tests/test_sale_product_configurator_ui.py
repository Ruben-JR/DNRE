...
class TestUi(odoo.tests.HttpCase, TestProductConfiguratorCommon):
    ...
    def test_02_product_configurator_advanced(self):
        ...
        self.start_tour(
            "/web", "sale_product_configurator_advanced_tour", login="admin"
        )
    ...
    def test_05_product_configurator_pricelist(self):
        ...
        self.start_tour(
            "/web", "sale_product_configurator_pricelist_tour", login="admin"
        )
    ...
    def test_06_product_configurator_optional_products(self):
        ...
        self.start_tour(
            "/web", "sale_product_configurator_optional_products_tour", login="admin"
        )
