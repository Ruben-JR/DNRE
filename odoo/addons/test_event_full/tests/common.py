...
class TestEventFullCommon(
    TestEventCrmCommon, TestSalesCommon, EventDtPatcher, MockVisitor
):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
                ...
                "registration_answer_ids": [
                    (
                        ...
                        0,
                        {
                            ...
                            "value_answer_id": cls.event_question_1.answer_ids[
                                (x % 2)
                            ].id,
                        },
                    ),
                    (
                        ...
                        0,
                        {
                            ...
                            "value_answer_id": cls.event_question_2.answer_ids[
                                (x % 2)
                            ].id,
                        },
                    ),
...
class TestWEventCommon(
    HttpCaseWithUserDemo, HttpCaseWithUserPortal, EventDtPatcher, MockVisitor
):
    def setUp(self):
        super().setUp()
