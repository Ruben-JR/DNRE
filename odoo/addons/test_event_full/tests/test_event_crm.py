...
class TestEventCrm(TestEventFullCommon):
    ...
    def test_event_crm_sale_customer(self):
        ...
        self.assertEqual(
            len(self.event_0.registration_ids), self.TICKET1_COUNT + self.TICKET2_COUNT
        )
    ...
    def test_event_crm_sale_mixed_group(self):
                ...
                "order_line": [
                    (
                        ...
                        0,
                        {
                            ...
                            "product_id": self.event_0.event_ticket_ids[
                                0
                            ].product_id.id,
                            "product_uom_qty": 2,
                        },
        ...
        public_regs = self.event_0.registration_ids.filtered(
            lambda reg: reg.sale_order_id == public_so
        )
        self.assertEqual(len(public_regs), 2)
        customer_regs = self.event_0.registration_ids.filtered(
