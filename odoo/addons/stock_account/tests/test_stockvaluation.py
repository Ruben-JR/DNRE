...
class TestStockValuation(TransactionCase):
    ...
    def _make_in_move(self, product, quantity, unit_cost=None):
        ...
        in_move = self.env["stock.move"].create(
            {
                "name": "in {} units @ {} per unit".format(
                    str(quantity), str(unit_cost)
                ),
    ...
    def test_fifo_perpetual_4(self):
        ...
        self.assertAlmostEqual(
            return_pick.move_lines.stock_valuation_layer_ids.unit_cost, 11.2
        )
    ...
    def test_forecast_report_value(self):
        ...
        report_value_1 = report_for_company_1._get_report_values(
            docids=self.product1.ids
        )
        report_value_2 = report_for_company_2._get_report_values(
            docids=self.product1.ids
        )
