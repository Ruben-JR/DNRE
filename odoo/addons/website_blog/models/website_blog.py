...
class BlogPost(models.Model):
    ...
    def _compute_website_url(self):
        ...
        for blog_post in self:
            blog_post.website_url = "/blog/{}/{}".format(
    ...
    write_uid = fields.Many2one(
        "res.users", "Last Contributor", index=True, readonly=True
    )
    ...
    def create(self, vals):
        post_id = super(BlogPost, self.with_context(mail_create_nolog=True)).create(
            vals
        )
