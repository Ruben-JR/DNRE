...
class HolidaysAllocation(models.Model):
    ...
    def _compute_leaves(self):
        for allocation in self:
            ...
            allocation.leaves_taken = sum(
                taken_leave.number_of_hours_display
                if taken_leave.leave_type_request_unit == "hour"
                else taken_leave.number_of_days
    ...
    def _compute_number_of_hours_display(self):
        for allocation in self:
            if (
                ...
                and allocation.parent_id.type_request_unit == "hour"
            ):
                allocation.number_of_hours_display = (
    ...
    def _compute_duration_display(self):
        for allocation in self:
            allocation.duration_display = "{:g} {}".format(
                (
            ...
            if not allocation.nextcall:
                ...
                if len(level_ids) > 1:
                    ...
                    allocation.nextcall = min(
                        second_level_start_date - relativedelta(days=1),
                        allocation.nextcall,
                    )
            ...
            while allocation.nextcall <= today:
                ...
                if (
                    ...
                    current_level_last_date = (
                        ...
                        + get_timedelta(next_level.start_count, next_level.start_type)
            ...
            if days_added_per_level:
                ...
                allocation.number_of_days = (
                    min(
                        ...
                        current_level.maximum_leave + allocation.leaves_taken,
                    )
                    if current_level.maximum_leave > 0
