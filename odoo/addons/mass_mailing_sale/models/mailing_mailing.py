...
class MassMailing(models.Model):
    ...
    def _compute_sale_quotation_count(self):
        has_so_access = self.env["sale.order"].check_access_rights(
        ...
        for mass_mailing in self:
            mass_mailing.sale_quotation_count = self.env["sale.order"].search_count(
    ...
    def _compute_sale_invoiced_amount(self):
        ...
        ) or not self.user_has_groups("account.group_account_invoice"):
        ...
        for mass_mailing in self:
            ...
            mass_mailing.sale_invoiced_amount = sum(
                i["amount_untaxed_signed"] for i in moves
            )
