...
class TestCRMLead(TestCrmCommon):
    ...
    def test_crm_lead_contact_fields_mixed(self):
        ...
        # other contact fields
        for fname in set(PARTNER_FIELDS_TO_SYNC) - {"function"}:
            self.assertEqual(
                lead[fname],
    ...
    def test_mailgateway(self):
        new_lead = self.format_and_process(
            ...
            f"{self.sales_team_1.alias_name}@{self.alias_domain}",
    ...
    def test_no_date_closed_update_between_won_stages(self):
        ...
        self.assertEqual(
            self.lead_1.date_closed,
            datetime.strptime("2020-02-02 18:00", "%Y-%m-%d %H:%M"),
        )
