...
class TestPoSOtherCurrencyConfig(TestPoSCommon):
    ...
    def test_01_check_product_cost(self):
        ...
        self.assertAlmostEqual(
            self.config.pricelist_id.get_product_price(self.product1, 1, self.customer),
            5.00,
        )
        self.assertAlmostEqual(
            self.config.pricelist_id.get_product_price(self.product2, 1, self.customer),
            12.99,
        )
        self.assertAlmostEqual(
            self.config.pricelist_id.get_product_price(self.product3, 1, self.customer),
            15.00,
        )
        self.assertAlmostEqual(
            self.config.pricelist_id.get_product_price(self.product4, 1, self.customer),
            50,
        )
        self.assertAlmostEqual(
            self.config.pricelist_id.get_product_price(self.product5, 1, self.customer),
            100,
        )
        self.assertAlmostEqual(
            self.config.pricelist_id.get_product_price(self.product6, 1, self.customer),
            22.65,
        )
        self.assertAlmostEqual(
            self.config.pricelist_id.get_product_price(self.product7, 1, self.customer),
            3.50,
        )
