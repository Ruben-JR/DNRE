...
class TestReporting(TestCommonReporting):
    def test_profitability_report(self):
        ...
        project_global_stat = (
            self.env["project.profitability.report"]
            .search([("project_id", "=", self.project_global.id)])
            .read()[0]
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["amount_untaxed_invoiced"],
                precision_rounding=rounding,
            ),
            "The invoiced amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["amount_untaxed_to_invoice"],
                precision_rounding=rounding,
            ),
            "The amount to invoice of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["timesheet_unit_amount"],
                precision_rounding=rounding,
            ),
            "The timesheet unit amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["timesheet_cost"], precision_rounding=rounding
            ),
            "The timesheet cost of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["expense_amount_untaxed_to_invoice"],
                precision_rounding=rounding,
            ),
            "The expense cost to reinvoice of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["expense_amount_untaxed_invoiced"],
                precision_rounding=rounding,
            ),
            "The expense invoiced amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["expense_cost"], precision_rounding=rounding
            ),
            "The expense cost of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["other_revenues"], precision_rounding=rounding
            ),
            "The other revenues of the global project should be 0.0",
        )
        ...
        project_so_1_stat = self.env["project.profitability.report"].read_group(
            [("project_id", "in", project_so_1.ids)],
            [
                "project_id",
        ...
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["amount_untaxed_invoiced"],
                precision_rounding=rounding,
            ),
            "The invoiced amount of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["amount_untaxed_to_invoice"],
                precision_rounding=rounding,
            ),
            "The amount to invoice of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["timesheet_unit_amount"], precision_rounding=rounding
            ),
            "The timesheet unit amount of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["timesheet_cost"], precision_rounding=rounding
            ),
            "The timesheet cost of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["expense_amount_untaxed_to_invoice"],
                precision_rounding=rounding,
            ),
            "The expense cost to reinvoice of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["expense_amount_untaxed_invoiced"],
                precision_rounding=rounding,
            ),
            "The expense invoiced amount of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["expense_cost"], precision_rounding=rounding
            ),
            "The expense cost of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["other_revenues"], precision_rounding=rounding
            ),
            "The other revenues of the project from SO1 should be 0.0",
        )
        ...
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["amount_untaxed_invoiced"],
                precision_rounding=rounding,
            ),
        ...
        self.assertEqual(
            float_compare(
                project_so_2_stat["amount_untaxed_to_invoice"],
                self.so_line_order_project.price_unit
                * self.so_line_order_project.qty_to_invoice,
                precision_rounding=rounding,
            ),
            0,
            "The amount to invoice should be the one from the SO line, as we are in ordered quantity",
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["timesheet_unit_amount"], precision_rounding=rounding
            ),
            "The timesheet unit amount of the project from SO2 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["timesheet_cost"], precision_rounding=rounding
            ),
            "The timesheet cost of the project from SO2 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["expense_amount_untaxed_to_invoice"],
                precision_rounding=rounding,
            ),
        ...
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["expense_amount_untaxed_invoiced"],
                precision_rounding=rounding,
            ),
            "The expense invoiced amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["expense_cost"], precision_rounding=rounding
            ),
            "The expense cost of the project from SO2 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["other_revenues"], precision_rounding=rounding
            ),
        ...
        project_so_3_stat = self.env["project.profitability.report"].read_group(
            [("project_id", "in", project_so_3.ids)],
            [
                "project_id",
                "amount_untaxed_to_invoice",
                "amount_untaxed_invoiced",
        ...
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["amount_untaxed_invoiced"],
                precision_rounding=rounding,
            ),
            "The invoiced amount of the project from SO3 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["amount_untaxed_to_invoice"],
                precision_rounding=rounding,
            ),
            "The amount to invoice of the project from SO3 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["timesheet_unit_amount"], precision_rounding=rounding
            ),
            "The timesheet unit amount of the project from SO3 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["timesheet_cost"], precision_rounding=rounding
            ),
            "The timesheet cost of the project from SO3 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["expense_amount_untaxed_to_invoice"],
                precision_rounding=rounding,
            ),
            "The expense cost to reinvoice of the project from SO3 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["expense_amount_untaxed_invoiced"],
                precision_rounding=rounding,
            ),
            "The expense invoiced amount of the project from SO3 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["expense_cost"], precision_rounding=rounding
            ),
            "The expense cost of the project from SO3 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["other_revenues"], precision_rounding=rounding
            ),
            "The other revenues of the project from SO3 should be 0.0",
        )
        ...
        project_global_stat = self.env["project.profitability.report"].read_group(
            [("project_id", "in", self.project_global.ids)],
            [
                "project_id",
                "amount_untaxed_to_invoice",
                "amount_untaxed_invoiced",
        ...
        self.assertEqual(
            float_compare(
                project_global_stat["amount_untaxed_to_invoice"],
                self.so_line_order_task.price_unit
                * self.so_line_order_task.qty_to_invoice,
                precision_rounding=rounding,
            ),
            0,
            "The amount to invoice of global project should take the task in 'oredered qty' into account",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["timesheet_unit_amount"],
        ...
        timesheet7 = self._log_timesheet_manager(
            self.project_global, 3, task_in_global_1
        )
        timesheet8 = self._log_timesheet_manager(
            self.project_global, 3, task_in_global_2
        )
        ...
        project_so_1_timesheet_cost = (
            timesheet1.amount + timesheet3.amount + timesheet5.amount
        )
        project_so_1_timesheet_sold_unit = (
            timesheet1.unit_amount + timesheet3.unit_amount + timesheet5.unit_amount
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["amount_untaxed_invoiced"],
        ...
        self.assertEqual(
            float_compare(
                project_so_1_stat["amount_untaxed_to_invoice"],
                self.so_line_deliver_project.price_unit
                * project_so_1_timesheet_sold_unit,
                precision_rounding=rounding,
            ),
            0,
            "The amount to invoice of the project from SO1 should only include timesheet linked to task",
        )
        self.assertEqual(
            float_compare(
                project_so_1_stat["timesheet_unit_amount"],
                project_so_1_timesheet_sold_unit,
                precision_rounding=rounding,
            ),
            0,
            "The timesheet unit amount of the project from SO1 should include all timesheet in project",
        )
        self.assertEqual(
            float_compare(
                project_so_1_stat["timesheet_cost"],
                project_so_1_timesheet_cost,
                precision_rounding=rounding,
            ),
            0,
            "The timesheet cost of the project from SO1 should include all timesheet",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["expense_amount_untaxed_to_invoice"],
        ...
        self.assertTrue(
            ...
            "The other revenues of the deliver project should be 0.0",
        )
        ...
        project_so_2_timesheet_cost = (
            timesheet2.amount + timesheet4.amount + timesheet6.amount
        )
        project_so_2_timesheet_sold_unit = (
            timesheet2.unit_amount + timesheet4.unit_amount + timesheet6.unit_amount
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["amount_untaxed_invoiced"],
        ...
        self.assertEqual(
            float_compare(
                project_so_2_stat["timesheet_unit_amount"],
                project_so_2_timesheet_sold_unit,
                precision_rounding=rounding,
            ),
            0,
            "The timesheet unit amount of the project from SO2 should include all timesheet",
        )
        self.assertEqual(
            float_compare(
                project_so_2_stat["timesheet_cost"],
                project_so_2_timesheet_cost,
                precision_rounding=rounding,
            ),
            0,
        ...
        self.assertEqual(
            float_compare(
                project_so_3_stat["timesheet_unit_amount"],
                project_so_3_timesheet_sold_unit,
                precision_rounding=rounding,
            ),
            0,
            "The timesheet unit amount of the project from SO3",
        )
        self.assertEqual(
            float_compare(
                project_so_3_stat["timesheet_cost"],
                project_so_3_timesheet_cost,
                precision_rounding=rounding,
            ),
            0,
            "The timesheet cost of the project from SO3",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["expense_amount_untaxed_to_invoice"],
        ...
        project_global_to_invoice = (
            self.so_line_order_task.price_unit * self.so_line_order_task.product_uom_qty
        ) + (self.so_line_deliver_task.price_unit * timesheet7.unit_amount)
        self.assertTrue(
            float_is_zero(
                project_global_stat["amount_untaxed_invoiced"],
                precision_rounding=rounding,
        ...
        self.assertEqual(
            ...
            0,
            "The amount to invoice of global project should take the task in 'oredered qty' and the delivered timesheets into account",
        )
        self.assertEqual(
            float_compare(
                project_global_stat["timesheet_unit_amount"],
                project_global_timesheet_unit,
                precision_rounding=rounding,
            ),
            0,
            "The timesheet unit amount of the global project should include all timesheet",
        )
        self.assertEqual(
            float_compare(
                project_global_stat["timesheet_cost"],
                project_global_timesheet_cost,
                precision_rounding=rounding,
            ),
            0,
            "The timesheet cost of the global project should include all timesheet",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["expense_amount_untaxed_to_invoice"],
        ...
        self.assertEqual(
            float_compare(
                project_so_3_stat["amount_untaxed_to_invoice"],
                self.so_line_deliver_manual_project.price_unit
                * self.so_line_deliver_manual_project.qty_to_invoice,
                precision_rounding=rounding,
            ),
            0,
            "The amount to invoice of the project from SO3 should be 0.0",
        ...
        InvoiceWizard = self.env["sale.advance.payment.inv"].with_context(
            mail_notrack=True
        )
        ...
        self.assertEqual(
            ...
            0,
            "The invoiced amount of the project from SO1 should only include timesheet linked to task",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["amount_untaxed_to_invoice"],
        ...
        self.assertEqual(
            ...
            0,
            "The invoiced amount should be the one from the SO line, as we are in ordered quantity",
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["amount_untaxed_to_invoice"],
            ...
            "The amount to invoice should be the one 0.0, as all ordered quantity is invoiced",
        )
        self.assertEqual(
            float_compare(
                project_so_2_stat["timesheet_unit_amount"],
        ...
        self.assertEqual(
            float_compare(
                project_so_3_stat["amount_untaxed_invoiced"],
                self.so_line_deliver_manual_project.price_unit
                * self.so_line_deliver_manual_project.qty_delivered,
                precision_rounding=rounding,
            ),
            0,
            "The invoiced amount of the project from SO3 should be the delivered quantity * the unit price",
        )
        self.assertTrue(
            float_is_zero(
                project_so_3_stat["amount_untaxed_to_invoice"],
        ...
        self.assertEqual(
            float_compare(
                project_so_1_stat["expense_cost"],
                expense1.amount,
                precision_rounding=rounding,
            ),
            0,
        ...
        self.assertEqual(
            float_compare(
                project_global_stat["expense_cost"],
                expense2.amount,
                precision_rounding=rounding,
            ),
            0,
    ...
    def test_reversed_downpayment(self):
        ...
        invoice_downpayment2 = self.env["account.move"].search(
            expression.AND(
                [action_invoice["domain"], [("id", "not in", posted_invoice_res_ids)]]
            )
        )
        invoice_downpayment2.action_post()
        posted_invoice_res_ids += invoice_downpayment2.ids
        milestone_to_invoice = (
            self.so_line_order_project.price_unit
            * self.so_line_order_project.qty_to_invoice
        )
        timesheets_to_invoice = (
            self.so_line_order_task.price_unit * self.so_line_order_task.qty_to_invoice
        )
        ...
        self.assertEqual(
            float_compare(
                project_so_2_stat["amount_untaxed_to_invoice"],
                milestone_to_invoice - 0.1 * total_product_price,
                precision_rounding=rounding,
            ),
            0,
        ...
        self.assertEqual(
            float_compare(
                project_so_2_stat["expense_cost"],
                expense1.amount,
                precision_rounding=rounding,
            ),
            0,
        ...
        action_invoice = payment.with_context(context).create_invoices()
        invoice_payment = self.env["account.move"].search(
            expression.AND(
                [action_invoice["domain"], [("id", "not in", posted_invoice_res_ids)]]
            )
        )
    ...
    def test_milestone_no_tracking(self):
        ...
        milestone_no_task = (
            so_line_deliver_no_task.price_unit * so_line_deliver_no_task.qty_to_invoice
        )
        self.env["project.profitability.report"].flush()
        ...
        self.assertEqual(
            float_compare(
                project_so_2_stat["amount_untaxed_to_invoice"],
                milestone_to_invoice + milestone_no_task,
                precision_rounding=rounding,
            ),
            0,
        ...
        timesheet = self._log_timesheet_user(
            project_so_2, 3, task_using_milestone_not_tracked
        )
        self.env["project.profitability.report"].flush()
        project_so_2_stat = self.env["project.profitability.report"].read_group(
            [("project_id", "in", project_so_2.ids)],
    ...
    def test_profitability_credit_note_bill(self):
        ...
        project_stat = ProjectProfitabilityReport.read_group(
            [("project_id", "in", self.project_global.ids)],
            [
                "project_id",
                "amount_untaxed_to_invoice",
        ...
        self.assertAlmostEqual(
            project_stat["amount_untaxed_invoiced"],
            0,
            msg="The invoiced amount of the project should be zero, before credit note.",
        )
        self.assertAlmostEqual(
            project_stat["amount_untaxed_to_invoice"],
            0,
            msg="The amount to invoice of the project should be zero, before credit note.",
        )
        self.assertAlmostEqual(
            project_stat["timesheet_unit_amount"],
            0,
            msg="The timesheet unit amount of the project should be zero, before credit note.",
        )
        self.assertAlmostEqual(
            project_stat["timesheet_cost"],
            0,
            msg="The timesheet cost of the project should be zero, before credit note.",
        )
        self.assertAlmostEqual(
            project_stat["expense_amount_untaxed_to_invoice"],
            0,
            msg="The expense cost to reinvoice of the project should be zero, before credit note.",
        )
        self.assertAlmostEqual(
            project_stat["expense_amount_untaxed_invoiced"],
            0,
            msg="The expense invoiced amount of the project should be zero, before credit note.",
        )
        self.assertAlmostEqual(
            project_stat["expense_cost"],
            test_bill.amount_total_signed,
            msg="The expense cost of the project should be equal to the the invoice line price, before credit note.",
        )
        self.assertAlmostEqual(
            project_stat["other_revenues"],
            0,
            msg="The other revenues of the project should be zero, before credit note",
        )
        ...
        self.assertAlmostEqual(
            project_stat["amount_untaxed_invoiced"],
            0,
            msg="The invoiced amount of the project should be zero, after credit note.",
        )
        self.assertAlmostEqual(
            project_stat["amount_untaxed_to_invoice"],
            0,
            msg="The amount to invoice of the project should be zero, after credit note.",
        )
        self.assertAlmostEqual(
            project_stat["timesheet_unit_amount"],
            0,
            msg="The timesheet unit amount of the project should be zero, after credit note.",
        )
        self.assertAlmostEqual(
            project_stat["timesheet_cost"],
            0,
            msg="The timesheet cost of the project should be zero, after credit note.",
        )
        self.assertAlmostEqual(
            project_stat["expense_amount_untaxed_to_invoice"],
            0,
            msg="The expense cost to reinvoice of the project should be zero, after credit note.",
        )
        self.assertAlmostEqual(
            project_stat["expense_amount_untaxed_invoiced"],
            0,
            msg="The expense invoiced amount of the project should be zero, after credit note.",
        )
        self.assertAlmostEqual(
            project_stat["expense_cost"],
            0,
            msg="The expense cost of the project should be zero, as it is balanced by credit note.",
        )
        self.assertAlmostEqual(
            project_stat["other_revenues"],
            0,
            msg="The other revenues (credit note) of the project should be zero (not taken into account), after credit note.",
        )
    ...
    def test_profitability_credit_note_invoice(self):
        ...
        self.assertAlmostEqual(
            project_stat["expense_cost"],
            0,
            msg="The expense cost of the project should be zero, before credit note.",
        )
        self.assertAlmostEqual(
            project_stat["other_revenues"],
            test_invoice.amount_total_signed,
            msg="The other revenues of the project should be equal to the the invoice line price, after credit note.",
        )
        ...
        self.assertAlmostEqual(
            project_stat["expense_cost"],
            0,
            msg="The expense costs (credit note) of the project should be zero (not taken into account), after credit note.",
        )
        self.assertAlmostEqual(
            project_stat["other_revenues"],
            0,
            msg="The other revenues of the project should be zero, as it is balanced by credit note.",
        )
    ...
    def test_project_profitability_report(self):
        ...
        self.assertEqual(
            float_compare(
                project_so_1_stat["other_revenues"],
                invoice_1.amount_untaxed,
                precision_rounding=rounding,
            ),
            0,
            "The other revenues of the project from SO1 should be the same as the untaxed amount in invoice",
        )
