...
class TestMrpOrder(TestMrpCommon):
    ...
    def test_qty_producing(self):
        ...
        self.assertEqual(
            production.workorder_ids.qty_producing,
            5,
            "Wrong quantity is suggested to produce.",
        )
    ...
    def test_product_produce_4(self):
        ...
        self.assertEqual(
            sum(ml_p1.mapped("product_uom_qty")),
            5.0,
    ...
    def test_product_produce_6(self):
        ...
        self.assertEqual(
            sum(mo.move_raw_ids.mapped("move_line_ids.product_uom_qty")), 0
        )
    ...
    def test_components_availability(self):
        ...
        mo.invalidate_cache(
            ["components_availability", "components_availability_state"], mo.ids
        )
        self.assertEqual(
