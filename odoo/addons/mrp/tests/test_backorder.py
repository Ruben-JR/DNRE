...
class TestMrpProductionBackorder(TestMrpCommon):
    ...
    def test_backorder_and_orderpoint(self):
        ...
        (
            ...
            product_to_use_1,
            product_to_use_2,
        ) = self.generate_mo(qty_final=4, qty_base_1=1)
        ...
        self.assertEqual(
            ...
            2,
            "MO backorder not linked to original MO",
        )
        ...
        self.assertEqual(
            len(mo_orderpoint.procurement_group_id.mrp_production_ids),
            1,
            "Reordering rule MO incorrectly linked to other MOs",
        )
