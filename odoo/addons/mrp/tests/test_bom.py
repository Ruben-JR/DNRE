...
class TestBoM(TestMrpCommon):
    ...
    def test_13_negative_on_hand_qty(self):
        ...
        self.product_2.invalidate_cache(
            fnames=["qty_available"], ids=self.product_2.ids
        )
    ...
    def test_20_bom_report(self):
        ...
        for component_line in report_values["lines"]["components"]:
            ...
            if component_line["prod_id"] == butter.id:
                ...
                self.assertEqual(
                    float_compare(
                        component_line["total"], (7.01 * 5), precision_digits=2
                    ),
                    0,
                )
            if component_line["prod_id"] == biscuit.id:
                ...
                self.assertEqual(
                    float_compare(
                        component_line["total"], (1.5 * 6), precision_digits=2
                    ),
                    0,
                )
        # total price = 35.05 + 9 + operation_cost(23.84) = 67.89
        self.assertEqual(
            float_compare(report_values["lines"]["total"], 67.89, precision_digits=2),
            0,
            "Product Bom Price is not correct",
        )
        self.assertEqual(
            float_compare(
                report_values["lines"]["total"] / 11.0, 6.17, precision_digits=2
            ),
            0,
        ...
        self.assertEqual(
            float_compare(report_values["lines"]["total"], 6.17, precision_digits=2),
            0,
            "Product Unit Bom Price is not correct",
        )
        ...
        for component_line in report_values["lines"]["components"]:
            ...
            if component_line["prod_id"] == cream.id:
                ...
                self.assertEqual(
                    float_compare(
                        component_line["total"], (3 * 5.17), precision_digits=2
                    ),
                    0,
                )
            if component_line["prod_id"] == crumble.id:
                ...
                self.assertEqual(
                    float_compare(
                        component_line["total"], crumble_cost, precision_digits=2
                    ),
                    0,
                )
        # total price = Cream (15.51€) + crumble_cost (34.63 €) + operation_cost(208,33) = 258.47€
        self.assertEqual(
            float_compare(report_values["lines"]["total"], 258.47, precision_digits=2),
            0,
            "Product Bom Price is not correct",
        )
    ...
    def test_21_bom_report_variant(self):
        ...
        self.assertEqual(
            blue_paint.id, report_values["lines"]["components"][0]["prod_id"]
        )
        ...
        self.assertEqual(
            blue_dashboard_gps.id, report_values["lines"]["components"][1]["prod_id"]
        )
        ...
        self.assertEqual(
            blue_paint.id, report_values_dashboad["components"][0]["prod_id"]
        )
        self.assertEqual(
            self.gps.id, report_values_dashboad["components"][1]["prod_id"]
        )
