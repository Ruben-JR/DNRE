...
class SaleOrder(models.Model):
    ...
    def create(self, vals):
        if "warehouse_id" not in vals and "company_id" in vals:
            ...
            vals["warehouse_id"] = (
                user.with_company(vals.get("company_id"))._get_default_warehouse_id().id
            )
    ...
    def write(self, values):
        ...
        if values.get("commitment_date"):
            ...
            self.order_line.move_ids.date_deadline = fields.Datetime.to_datetime(
    ...
    def _onchange_company_id(self):
        if self.company_id:
            ...
            self.warehouse_id = (
                warehouse_id
                or self.user_id.with_company(self.company_id.id)
    ...
    def onchange_user_id(self):
        ...
        if self.state in ["draft", "sent"]:
            self.warehouse_id = (
                self.user_id.with_company(self.company_id.id)
                ._get_default_warehouse_id()
                .id
            )
    ...
    def _get_outgoing_incoming_moves(self):
        ...
        if self._context.get("accrual_entry_date"):
            moves = moves.filtered(
                lambda r: fields.Date.to_date(r.date)
