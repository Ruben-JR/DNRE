...
class WebsiteVisitor(models.Model):
    ...
    @api.depends(
        "parent_id",
        "event_track_visitor_ids.track_id",
    ...
    def _compute_event_track_wishlisted_ids(self):
        ...
        for visitor in self:
            ...
            visitor.event_track_wishlisted_ids = visitor_track_ids + [
                track_id
                for track_id in parent_track_ids
                if track_id not in visitor_track_ids
            ]
    ...
    def _link_to_visitor(self, target, keep_unique=True):
        ...
        return super()._link_to_visitor(target, keep_unique=keep_unique)
