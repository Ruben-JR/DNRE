...
class Track(models.Model):
    ...
    is_track_soon = fields.Boolean(
        "Is Track Soon", compute="_compute_track_time_data", help="Track begins soon"
    )
    is_track_today = fields.Boolean(
        "Is Track Today", compute="_compute_track_time_data", help="Track begins today"
    )
    ...
    is_track_done = fields.Boolean(
        "Is Track Done", compute="_compute_track_time_data", help="Track is finished"
    )
    ...
    def _compute_website_url(self):
        ...
        for track in self:
            if track.id:
                track.website_url = "/event/{}/track/{}".format(
                    slug(track.event_id),
                    slug(track),
                )
        ...
        for track in self:
            ...
            if track.partner_function:
                if track.partner_company_name:
                    ...
                    tag_line = f"{track.partner_name}, {track.partner_function}"
