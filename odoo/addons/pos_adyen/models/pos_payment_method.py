...
class PosPaymentMethod(models.Model):
    ...
    adyen_latest_response = fields.Char(
        help="Technical field used to buffer the latest asynchronous notification from Adyen.",
        copy=False,
        groups="base.group_erp_manager",
    )
    adyen_latest_diagnosis = fields.Char(
        help="Technical field used to determine if the terminal is still connected.",
        copy=False,
        groups="base.group_erp_manager",
    )
