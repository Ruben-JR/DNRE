    ...
    def _constraint_kode_ppn(self):
        ...
        for move in self.filtered(lambda m: m.l10n_id_kode_transaksi != "08"):
            if any(
                ...
                if line.exclude_from_invoice_tab is False and not line.display_type
            ) and any(
        ...
        for move in self:
            if move.l10n_id_need_kode_transaksi:
                ...
                if move.l10n_id_replace_invoice_id.l10n_id_tax_number:
                    ...
                    move.l10n_id_tax_number = "{}1{}".format(
    ...
    def _generate_efaktur_invoice(self, delimiter):
        ...
        for move in self.filtered(lambda m: m.state == "posted"):
            ...
            lines = move.line_ids.filtered(
                lambda x: x.product_id.id == int(dp_product_id)
                and x.price_unit < 0
            ...
            for line in move.line_ids.filtered(
                lambda l: not l.exclude_from_invoice_tab and not l.display_type
            ):
