...
class Meeting(models.Model):
    ...
    def _microsoft_to_odoo_values(
        self, microsoft_event, default_reminders=(), default_values={}
    ):
    ...
    def _microsoft_to_odoo_recurrence_values(
        self, microsoft_event, default_reminders=(), values={}
    ):
        timeZone_start = pytz.timezone(microsoft_event.start.get("timeZone"))
        timeZone_stop = pytz.timezone(microsoft_event.end.get("timeZone"))
        start = (
    ...
    def _ensure_attendees_have_email(self):
        ...
        if invalid_event_ids:
            ...
            invalid_events = [
                "\t- {}: {}".format(event["display_time"], event["display_name"])
