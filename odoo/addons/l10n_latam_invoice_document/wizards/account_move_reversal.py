...
class AccountMoveReversal(models.TransientModel):
    ...
    l10n_latam_available_document_type_ids = fields.Many2many(
        "l10n_latam.document.type", compute="_compute_document_type"
    )
    ...
    def _inverse_document_type(self):
        ...
        self.l10n_latam_document_number = "{}|{}".format(
            self.l10n_latam_document_type_id.id or "",
            self.l10n_latam_document_number or "",
        )
    ...
    def _prepare_default_reversal(self, move):
        ...
        if self.l10n_latam_document_number and "|" in self.l10n_latam_document_number:
            ...
            ) = self.l10n_latam_document_number.split("|")
            res.update(
                {
                    "l10n_latam_document_type_id": int(l10n_latam_document_type_id)
