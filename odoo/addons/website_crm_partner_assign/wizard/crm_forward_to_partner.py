...
class CrmLeadForwardToPartner(models.TransientModel):
    ...
    def get_lead_portal_url(self, lead):
        ...
        action_ref = self.env.ref(f"website_crm_partner_assign.{action}", False)
        portal_link = "{}/?db={}#id={}&action={}&view_type=form".format(
            lead.get_base_url(),
            self.env.cr.dbname,
            lead.id,
    ...
    def get_portal_url(self):
        ...
        portal_link = f"{portal_url}/?db={self.env.cr.dbname}"
        return portal_link
