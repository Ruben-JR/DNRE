...
class TestItEdi(AccountEdiTestCommon):
    ...
    def test_non_latin_and_latin_inovice(self):
        invoice_etree = etree.fromstring(
            self.non_latin_and_latin_invoice._export_as_xml()
        )
        expected_etree = self.with_applied_xpath(
            etree.fromstring(self.edi_basis_xml),
            """
    ...
    def test_below_400_codice_simplified_invoice(self):
        invoice_etree = etree.fromstring(
            self.below_400_codice_simplified_invoice._export_as_xml()
        )
        expected_etree = self.with_applied_xpath(
    ...
    def test_total_400_VAT_simplified_invoice(self):
        invoice_etree = etree.fromstring(
            self.total_400_VAT_simplified_invoice._export_as_xml()
        )
        expected_etree = self.with_applied_xpath(
            etree.fromstring(self.edi_simplified_basis_xml),
            """
