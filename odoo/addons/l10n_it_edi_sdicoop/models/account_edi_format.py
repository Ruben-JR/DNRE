        ...
        for proxy_user in proxy_users:
            ...
            try:
                res = proxy_user._make_request(
                    ...
                    + "/api/l10n_it_edi/1/in/RicezioneInvoice",
            ...
            for id_transaction, fattura in res.items():
                ...
                )._create_invoice_from_xml_tree(fattura["filename"], tree)
                ...
                if "00404" in error_codes:
                    ...
                    to_return[invoice] = {
                        "error": self._format_error_message(
                            _("The invoice has been refused by the Exchange System"),
                            errors,
                        ),
                        "blocking_level": "error",
                    }
