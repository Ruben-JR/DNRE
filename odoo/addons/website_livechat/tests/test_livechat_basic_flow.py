...
class TestLivechatBasicFlowHttpCase(tests.HttpCase, TestLivechatCommon):
    def test_visitor_banner_history(self):
        ...
        handmade_history = "{} (21:10) → {} (21:20) → {} (21:30)".format(
    ...
    def test_livechat_username(self):
        ...
        self.assertEqual(
            channel_1.name,
            f"{self.visitor.display_name} {self.operator.livechat_username}",
        )
        channel_1.unlink()
        ...
        # Check Channel naming
        self.assertEqual(
            channel_2.name, f"{self.visitor.display_name} {self.operator.name}"
        )
    ...
    def _common_basic_flow(self):
        ...
        self.assertEqual(
            ...
            "{} #{}".format(_("Website Visitor"), self.visitor.id),
        )
        self.assertEqual(
            channel.name,
            f"{self.visitor.display_name} {self.operator.livechat_username}",
