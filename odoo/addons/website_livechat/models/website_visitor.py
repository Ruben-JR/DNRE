...
class WebsiteVisitor(models.Model):
    ...
    def action_send_chat_request(self):
        ...
        for visitor in self:
            ...
            visitor_name = (
                f"{visitor.display_name} ({country.name})"
                if country
            ...
            if visitor.partner_id:
                ...
                channel_partner_to_add.append(
                    (4, self.env.ref("base.public_partner").id)
                )
    ...
    def _link_to_visitor(self, target, keep_unique=True):
        ...
        super()._link_to_visitor(target, keep_unique=keep_unique)
