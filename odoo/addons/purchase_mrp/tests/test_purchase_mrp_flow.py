...
class TestSaleMrpFlow(TransactionCase):
    def setUp(self):
        ...
        self.uom_kg.write({"name": "Test-KG", "rounding": 0.000001})
        ...
        self.uom_unit.write({"name": "Test-Unit", "rounding": 0.01})
        ...
        BomLine.create(
            {"product_id": self.kit_1.id, "product_qty": 2.0, "bom_id": bom_kit_2.id}
        )
