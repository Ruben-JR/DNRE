...
class ResConfigSettings(models.TransientModel):
    ...
    google_drive_authorization_code = fields.Char(
        string="Authorization Code", config_parameter="google_drive_authorization_code"
    )
    ...
    def get_values(self):
        ...
        refresh_token = (
            ...
            .sudo()
            .get_param("google_drive_refresh_token", False)
        )
    ...
    def confirm_setup_token(self):
        ...
        if authorization_code != authorization_code_before:
            refresh_token = (
                self.env["google.service"].generate_refresh_token(
