...
def pager(url, total, page=1, step=30, scope=5, url_args=None):
    ...
    def get_url(page):
        ...
        if url_args:
            _url = "{}?{}".format(_url, urls.url_encode(url_args))
        return _url
...
class CustomerPortal(Controller):
    ...
    def security(self, **post):
        ...
        return request.render(
            "portal.portal_my_security", values, headers={"X-Frame-Options": "DENY"}
        )
