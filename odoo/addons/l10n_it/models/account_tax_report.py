...
class AccountTaxReportLine(models.AbstractModel):
    ...
    def vp14_debt_carryover_condition(self, options, line_amount, carried_over_amount):
        ...
        amount_in_euro = base_currency._convert(
            line_amount, target_currency, company, options["date"]["date_to"]
        )
    ...
    def vp14_credit_carryover_condition(
    ...
    def _get_carryover_destination_line(self, options):
        self.ensure_one()
        italian_report_id = self.env["ir.model.data"]._xmlid_to_res_id(
