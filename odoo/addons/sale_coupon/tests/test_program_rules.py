...
class TestProgramRules(TestSaleCouponCommon):
    ...
    def test_program_rules_minimum_purchased_amount(self):
        ...
        self.immediate_promotion_program.rule_minimum_amount_tax_inclusion = (
            "tax_included"
        )
        order.recompute_coupon_lines()
        self.assertEqual(
    ...
    def test_program_rules_one_date(self):
        ...
        order.recompute_coupon_lines()
        self.assertNotIn(
            self.immediate_promotion_program, order._get_applicable_programs()
        )
        self.assertEqual(
            len(order.order_line.ids),
            2,
    ...
    def test_program_rules_coupon_qty_and_amount_remove_not_eligible(self):
        ...
        * Ensure that if a reward from a coupon_program was allowed and the conditions are not met anymore,
        ...
        self.assertEqual(
            coupon.state,
            "used",
            "The coupon should be set to Consumed as it has been used",
        )
        ...
        self.assertEqual(
            coupon.state,
            "new",
            "The coupon should be reset to Valid as it's reward got removed",
        )
    ...
    def test_program_rules_promotion_use_best(self):
        ...
        * Verify the best global promotion according to the
        ...
        self.assertTrue(
            "Get 5% discount" in discounts.pop(), "The discount should be a 5% discount"
        )
        ...
        self.assertTrue(
            "Get 10% discount" in discounts.pop(),
