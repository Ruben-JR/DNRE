...
class SaleCouponApplyCode(models.TransientModel):
    ...
    def apply_coupon(self, order, coupon_code):
        ...
        if program:
            ...
            if not error_status:
                if program.promo_applicability == "on_next_order":
                    ...
                    if (
                        ...
                        not in order.generated_coupon_ids.filtered(
                            lambda coupon: coupon.state in ["new", "reserved"]
                        )
            ...
            if coupon:
                error_status = coupon._check_coupon_code(
                ...
                error_status = {
                    "not_found": _("This coupon is invalid (%s).") % (coupon_code)
                }
        return error_status
