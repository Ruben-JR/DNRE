...
class TestStreetFields(TransactionCase):
        ...
        for key, val in street_data.items():
            ...
            if isinstance(record[key], models.BaseModel):
                self.assertEqual(
                    record[key].id,
                    val,
                    "Wrongly formatted street field %s: expected %s, received %s"
                    % (key, val, record[key]),
                )
            else:
                self.assertEqual(
    ...
    def test_company_create(self):
        ...
        input_values = [
            ...
            {
                "country_id": ch_id,
                "street": "header Chaussee de Namur, 40 - 2b trailer",
            },
        ...
        expected = [
            ...
            {
                "street_name": "de Namur",
                "street_number": "Chaussee",
                "street_number2": False,
            },
            {
                "street_name": "Av. Miguel Hidalgo y Costilla",
                "street_number": "601",
                "street_number2": False,
            },
            {
        ...
        for idx, (company_values, expected_vals) in enumerate(
            zip(input_values, expected)
        ):
    ...
    def test_company_write(self):
        ...
        expected = [
            ...
            {
                "street_name": "Chee de Namur",
                "street_number": "40",
                "street_number2": False,
                "street": "Chee de Namur, 40",
            },
            {
                "street_name": "Chee de Namur",
                "street_number": "40",
                "street_number2": "4",
                "street": "Chee de Namur, 40/4",
            },
            {
                "street_name": "Chee de Namur",
                "street_number": "40",
                "street_number2": "4",
                "street": "40/4 Chee de Namur",
            },
        ]
