...
class WebsiteForum(WebsiteProfile):
    ...
    def questions(
        ...
        **post
        ...
        if tag:
            url = "/forum/{}/tag/{}/questions".format(slug(forum), slug(tag))
        else:
    ...
    def old_question(self, forum, question, **post):
        ...
        return request.redirect(
            _build_url_w_params(
                "/forum/{}/{}".format(slug(forum), slug(question)), request.params
            ),
            code=301,
        )
    ...
    def question(self, forum, question, **post):
        ...
        if question.parent_id:
            redirect_url = "/forum/{}/{}".format(slug(forum), slug(question.parent_id))
    ...
    def question_edit_answer(self, forum, question, **kwargs):
        for record in question.child_ids:
            if record.create_uid.id == request.uid:
                ...
                break
        return request.redirect(
            "/forum/{}/post/{}/edit".format(slug(forum), slug(answer))
        )
    ...
    def question_close(self, forum, question, **post):
        ...
        return request.redirect(
            "/forum/{}/question/{}".format(slug(forum), slug(question))
        )
    ...
    def question_reopen(self, forum, question, **kwarg):
        question.reopen()
        return request.redirect("/forum/{}/{}".format(slug(forum), slug(question)))
    ...
    def post_delete(self, forum, post, **kwargs):
        ...
        post.unlink()
        if question:
            request.redirect("/forum/{}/{}".format(slug(forum), slug(question)))
    ...
    def post_mark_as_offensive(self, forum, post, **kwargs):
        ...
        url = ""
        if post.parent_id:
            url = "/forum/{}/{}/#answer-{}".format(
                slug(forum), post.parent_id.id, post.id
            )
        else:
            url = "/forum/{}/{}".format(slug(forum), slug(post))
        return request.redirect(url)
