...
class WebsiteVisitorTests(MockVisitor, HttpCaseWithUserDemo):
    ...
    def test_visitor_creation_on_tracked_page(self):
        ...
        self.assertVisitorTracking(
            visitor_admin, self.tracked_page | self.tracked_page_2
        )
        ...
        visitor_anonymous = (
            ...
            .search([("id", "=", visitor_anonymous.id)])
        )
    ...
    def test_visitor_archive(self):
        ...
        self.assertEqual(
            ...
            old_visitor,
            "Visitor and its partner should be synchronized",
        )
        ...
        self.assertEqual(
            old_visitor.active, False, "Visitor should be archived after inactivity"
        )
        ...
        self.assertTrue(
            new_visitor.id > old_visitor.id, "A new visitor should have been created."
        )
        self.assertVisitorTracking(new_visitor, self.tracked_page)
        ...
        self.assertEqual(
            partner_demo.visitor_ids,
            old_visitor,
            "The partner visitor should be back to the 'old' visitor.",
        )
        ...
        self.assertEqual(
            len(new_visitor),
            0,
            "The new visitor should be deleted when visitor authenticate once again.",
        )
        self.assertEqual(
            old_visitor.active,
            True,
            "The old visitor should be reactivated when visitor authenticates once again.",
        )
