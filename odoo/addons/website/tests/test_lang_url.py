...
class TestLangUrl(HttpCase):
    ...
    def test_02_url_redirect(self):
        ...
        self.assertTrue(
            ...
            "fr_WHATEVER should be forwarded to 'fr_FR' lang as closest match",
        )
        ...
        self.assertTrue(
            r.url.endswith("/fr/contactus"),
            "lang in url should use url_code ('fr' in this case)",
        )
...
class TestControllerRedirect(TestLangUrl):
    ...
    def test_01_controller_redirect(self):
        ...
        def assertUrlRedirect(url, expected_url, msg="", code=301):
            ...
            if not msg:
                msg = f"Url <{url}> differ from <{expected_url}>."
