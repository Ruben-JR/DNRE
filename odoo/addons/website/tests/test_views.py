...
class TestCowViewSaving(TestViewSavingCommon):
    ...
    def test_cow_cross_inherit(self):
        ...
        generic_view = View.with_context(website_id=None).get_view_id(
            "website.main_view"
        )
    ...
    def test_module_new_inherit_view_on_parent_already_forked(self):
        ...
        Website.with_context(load_all_views=True).viewref(
    ...
    def test_specific_view_translation(self):
        ...
        self.assertEqual(
            specific_view.with_context(lang="en_US").arch,
            "<div>hello</div>",
