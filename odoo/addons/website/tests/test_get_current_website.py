...
class TestGetCurrentWebsite(TransactionCase):
    def test_01_get_current_website_id(self):
        ...
        self.assertEqual(
            ...
            Website.search([]).sorted("country_group_ids")[0].id,
        )
        ...
        self.assertEqual(
            Website._get_current_website_id("my-site-1.fr", False), website1.id
        )

        # CASE: domain set: get matching domain (scheme and port supported)
        self.assertEqual(
            Website._get_current_website_id("my-site-1.fr:8069", False), website1.id
        )

        self.assertEqual(
            Website._get_current_website_id("my2ndsite.com:80", False), website2.id
        )
        self.assertEqual(
            Website._get_current_website_id("my2ndsite.com:8069", False), website2.id
        )
        self.assertEqual(
            Website._get_current_website_id("my2ndsite.com", False), website2.id
        )

        # CASE: domain set, wrong domain: get first
        self.assertEqual(
            Website._get_current_website_id("test.com", False), website1.id
        )

        # CASE: subdomain: not supported
        self.assertEqual(
            Website._get_current_website_id("www.my2ndsite.com", False), website1.id
        )
        ...
        self.assertEqual(
            Website._get_current_website_id("my2ndsite.com", country1.id), website2.id
        )
        self.assertEqual(
            Website._get_current_website_id("my2ndsite.com", country2.id), website2.id
        )
        self.assertEqual(
            Website._get_current_website_id("my-site-1.fr", country3.id), website1.id
        )

        # CASE: domain set, wrong country: get first for domain
        self.assertEqual(
            Website._get_current_website_id("my2ndsite.com", country4.id), website2.id
        )

        # CASE: domain set, multiple country: get first for domain
        website1.domain = website2.domain
        self.assertEqual(
            Website._get_current_website_id("my2ndsite.com", country5.id), website1.id
        )
        ...
        self.assertEqual(
            Website._get_current_website_id("site-1.com", False), website1.id
        )
        self.assertEqual(
        ...
        self.assertEqual(
            Website._get_current_website_id("site-1.com:80", False), website1.id
        )
        self.assertEqual(
            Website._get_current_website_id("site-1.com:81", False), website2.id
        )
        self.assertEqual(
            Website._get_current_website_id("site-1.com:82", False), website1.id
        )
        self.assertEqual(
            Website._get_current_website_id("site-1.com", False), website1.id
        )
