...
class ResConfigSettings(models.TransientModel):
    ...
    auth_signup_uninvited = fields.Selection(
        compute="_compute_auth_signup", inverse="_set_auth_signup"
    )
    ...
    google_maps_api_key = fields.Char(
        related="website_id.google_maps_api_key", readonly=False
    )
    ...
    has_google_maps = fields.Boolean(
        "Google Maps", compute=has_google_maps, inverse=inverse_has_google_maps
    )
    ...
    def action_ping_sitemap(self):
        ...
        return {
            ...
            % self.website_id._get_http_domain(),
            "target": "new",
        }
