...
class View(models.Model):
    ...
    def write(self, vals):
        ...
        for view in self.with_context(active_test=False):
            ...
            if vals.get("arch"):
                ...
                to_invalidate and _logger.info(
                    "Disable cache for page %s", to_invalidate
                )
    ...
    def _handle_visibility(self, do_raise=True):
        ...
        if self.visibility and not request.env.user.has_group(
    ...
    def _render(self, values=None, engine="ir.qweb", minimal_qcontext=False):
        ...
        if request and getattr(request, "is_frontend", False):
            ...
            translatable = (
                editable
                and self._context.get("lang") != request.website.default_lang_id.code
            )
        ...
        return super()._render(values, engine=engine, minimal_qcontext=minimal_qcontext)
    ...
    def _prepare_qcontext(self):
        ...
        if request and getattr(request, "is_frontend", False):
            ...
            ) and self.env.user.has_group("website.group_multi_website"):
                ...
                qcontext["multi_website_websites"] = [
                    {
                        ...
                        "name": website.name,
                        "domain": website._get_http_domain(),
                    }
            ...
            qcontext.update(
                dict(
                    ...
                    .browse(request.website._get_cached("company_id"))
                    .sudo(),
