...
class Attachment(models.Model):
    ...
    website_url = fields.Char(
        string="Website URL", related="local_url", deprecated=True, readonly=False
    )
    key = fields.Char(
        help="Technical field used to resolve multiple attachments in a multi-website environment."
    )
    ...
    def get_serve_attachment(
        ...
        return super().get_serve_attachment(url, extra_domain, extra_fields, order)
