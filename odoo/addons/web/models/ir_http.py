...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        translation_hash = (
            request.env["ir.translation"].sudo().get_web_translations_hash(mods, lang)
        )
        session_info = {
            "uid": session_uid,
    ...
    def get_frontend_session_info(self):
        session_info = {
            ...
            "is_website_user": request.session.uid
            ...
            "profile_collectors": request.session.profile_collectors,
            "profile_params": request.session.profile_params,
            "show_effect": request.env["ir.config_parameter"]
            .sudo()
