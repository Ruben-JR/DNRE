...
class SaleOrderLine(models.Model):
    ...
    project_id = fields.Many2one(
        ...
        index=True,
        copy=False,
        help="Project generated by the sales order item",
    )
    task_id = fields.Many2one(
        ...
        index=True,
        copy=False,
        help="Task generated by the sales order item",
    )
    ...
    def _timesheet_create_project_prepare_values(self):
        ...
        return {
            "name": f"{self.order_id.client_order_ref} - {self.order_id.name}"
    ...
    def _timesheet_create_task_prepare_values(self, project):
        ...
        return {
            ...
            else "{}: {}".format(self.order_id.name or "", title),
    ...
    def _prepare_invoice_line(self, **optional_values):
        ...
        if self.task_id.analytic_tag_ids:
            values["analytic_tag_ids"] += [
                Command.link(tag_id.id) for tag_id in self.task_id.analytic_tag_ids
            ]
        elif self.is_service and not self.is_expense:
