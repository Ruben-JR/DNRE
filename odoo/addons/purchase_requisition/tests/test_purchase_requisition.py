...
class TestPurchaseRequisition(TestPurchaseRequisitionCommon):
    ...
    def test_02_purchase_requisition(self):
        ...
        self.assertEqual(
            supplierinfo09.name, seller_partner1, "The supplierinfo is not the good one"
        )
        self.assertEqual(
            supplierinfo09.price,
            price_product09,
            "The supplierinfo is not the good one",
        )
        ...
        self.assertEqual(
            supplierinfo13.name, seller_partner1, "The supplierinfo is not the good one"
        )
        self.assertEqual(
            supplierinfo13.price,
            price_product13,
            "The supplierinfo is not the good one",
        )
