...
class TestMailgateway(TestMailCommon):
    ...
    def test_message_process_followers(self):
        ...
        self.assertEqual(
            record3.message_ids[0].email_from, self.partner_1.email_formatted
        )
        self.assertEqual(
    ...
    def test_message_process_bounce_alias(self):
        ...
        bounce_email_to = "{}@{}".format("bounce.test", "test.com")
        record = self.format_and_process(
            MAIL_TEMPLATE,
            self.partner_1.email_formatted,
            bounce_email_to,
    ...
    def test_message_process_reply_to_new_thread(self):
        ...
        self.assertEqual(
            ...
            formataddr(
                (
                    f"{self.user_employee.company_id.name} {first_record.name}",
                    "{}@{}".format("catchall.test", "test.com"),
                )
            ),
        )
    ...
    def test_gateway_values_base64_image(self):
        ...
        record = self.format_and_process(
            ...
            self.email_from,
            f"{alias.alias_name}@{self.alias_catchall}",
