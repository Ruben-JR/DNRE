...
class WebsiteSlidesSurvey(WebsiteSlides):
    ...
    def create_slide(self, *args, **post):
        ...
        if create_new_survey:
            ...
            result.update(
                {
                    "redirect_url": "/web#id=%s&action=%s&model=survey.survey&view_type=form"
                    % (post["survey_id"], action_id),
    ...
    def _set_completed_slide(self, slide):
        ...
        return super()._set_completed_slide(slide)
