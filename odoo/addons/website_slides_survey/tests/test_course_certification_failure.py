...
class TestCourseCertificationFailureFlow(TestSurveyCommon):
    def test_course_certification_failure_flow(self):
        ...
        self.assertIn(
            ...
            "Public user should still be a member of the course because he still has attempts left",
        )
        ...
        self.assertNotIn(
            self.user_public.partner_id,
            self.channel.partner_ids,
            "Public user should have been kicked out of the course because he failed his last attempt",
        )
        ...
        self.assertIn(
            self.user_public.partner_id,
            self.channel.partner_ids,
            "Public user should be a member of the course once again",
        )
        ...
        self.assertIn(
            self.user_public.partner_id,
            self.channel.partner_ids,
            "Public user should still be a member of the course",
        )
