...
class TestAccountMoveReconcile(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.extra_receivable_account_1 = cls.copy_account(
            cls.company_data["default_account_receivable"]
        )
        cls.extra_receivable_account_2 = cls.copy_account(
            cls.company_data["default_account_receivable"]
        )
    ...
    def test_reconcile_single_currency(self):
            ...
            [
                {
                    ...
                    "amount_residual_currency": 1000.0,
                    "reconciled": False,
                },
                {
        ...
        self.assertRecordValues(
            ...
            [
                {
                    "amount_residual": 700.0,
                    "amount_residual_currency": 700.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": 0.0,
        ...
        self.assertFullReconcile(
            res["full_reconcile"], line_1 + line_2 + line_3 + line_4 + line_5
        )
    ...
    def test_reconcile_same_foreign_currency(self):
            ...
            [
                {
                    ...
                    "line_ids": [
                        ...
                        (
                            0,
                            0,
                            {"debit": 0.0, "credit": 1320.0, "account_id": account_id},
                        ),
                    ],
                },
                {
                    ...
                    "line_ids": [
                        ...
                        (
                            0,
                            0,
                            {"debit": 1980.0, "credit": 0.0, "account_id": account_id},
                        ),
                    ],
                },
            ]
            ...
            [
                {
                    ...
                    "amount_residual_currency": 3600.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": 120.0,
                    "amount_residual_currency": 360.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -240.0,
                    "amount_residual_currency": -480.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -720.0,
                    "amount_residual_currency": -1440.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -1020.0,
                    "amount_residual_currency": -2040.0,
                    "reconciled": False,
                },
            ],
        )
        ...
        self.assertRecordValues(
            line_1 + line_3 + line_4,
            [
                {
                    "amount_residual": 240.0,
                    "amount_residual_currency": 1680.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": 0.0,
        ...
        exchange_diff_lines = exchange_diff.line_ids.sorted(
            lambda line: (
                line.currency_id,
    ...
    def test_reconcile_multiple_currencies(self):
            ...
            [
                {
                    ...
                    "line_ids": [
                        ...
                        (
                            0,
                            0,
                            {"debit": 0.0, "credit": 1980.0, "account_id": account_id},
                        ),
                    ],
                },
                {
        ...
        self.assertRecordValues(
            ...
            [
                ...
                {
                    "amount_residual": 780.0,
                    "amount_residual_currency": 2340.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -240.0,
                    "amount_residual_currency": -960.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -720.0,
                    "amount_residual_currency": -2880.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -1020.0,
                    "amount_residual_currency": -4080.0,
                    "reconciled": False,
                },
            ],
        )
        ...
        self.assertRecordValues(
            ...
            [
                {
                    "amount_residual": 0.0,
                    "amount_residual_currency": 1200.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -780.0,
                    "amount_residual_currency": -2640.0,
                    "reconciled": False,
                },
            ],
        )
    ...
    def test_reconcile_asymetric_rate_change(self):
        ...
        self.assertRecordValues(
            ...
            [
                {
                    "amount_residual": 1200.0,
                    "amount_residual_currency": 9600.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": 960.0,
                    "amount_residual_currency": 1920.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -1200.0,
    ...
    def test_reverse_exchange_difference_same_foreign_currency(self):
        ...
        rec_line_2016 = move_2016.line_ids.filtered(
            lambda line: line.account_id.internal_type == "receivable"
        )
        rec_line_2017 = move_2017.line_ids.filtered(
            lambda line: line.account_id.internal_type == "receivable"
        )

        self.assertRecordValues(
            rec_line_2016 + rec_line_2017,
            [
                {
                    "amount_residual": 1200.0,
                    "amount_residual_currency": 3600.0,
        ...
        reverse_exchange_diff = exchange_diff_lines[
            1
        ...
        self.assertRecordValues(
            exchange_diff_lines + reverse_exchange_diff_lines,
            [
                {
                    "amount_residual": 0.0,
                    "amount_residual_currency": 0.0,
        ...
        partials = (
            reverse_exchange_diff_lines.matched_debit_ids
            + reverse_exchange_diff_lines.matched_credit_ids
        )
        self.assertPartialReconcile(
            partials,
            [
    ...
    def test_reverse_exchange_multiple_foreign_currencies(self):
        ...
        self.assertRecordValues(
            ...
            [
                {
                    "amount_residual": 1200.0,
                    "amount_residual_currency": 7200.0,
                    "reconciled": False,
                },
                {
                    "amount_residual": -1200.0,
        ...
        reverse_exchange_diff_lines = reverse_exchange_diff.line_ids.sorted(
            "amount_currency"
        )
    ...
    def test_reconcile_cash_basis_exchange_difference_transfer_account_check_entries_1(
        ...
        self.assertFullReconcile(
            res["full_reconcile"], receivable_lines + receivable_lines2
        )

        exchange_diff = res["full_reconcile"].exchange_move_id
        exchange_diff_lines = exchange_diff.line_ids.filtered(
    ...
    def test_reconcile_cash_basis_exchange_difference_transfer_account_check_entries_2(
        ...
        self.assertTrue(
            exchange_move, "There should be an exchange difference move created"
        )
        self.assertRecordValues(
    ...
    def test_reconcile_cash_basis_exchange_difference_transfer_account_check_entries_3(
        ...
        self.assertRecordValues(
            ...
            [
                ...
                {
                    "account_id": caba_move.company_id.income_currency_exchange_account_id.id,
                    "debit": 0.0,
                    "credit": 0.0,
                    "amount_currency": -36.67,
                    "tax_ids": [],
    ...
    def test_caba_foreign_vat(self):
        ...
        self.assertEqual(
            ...
            foreign_vat_fpos,
            "The foreign VAT fiscal position should be kept in the the cash basis move.",
        )
