    ...
    def test_30_fp_delivery_address(self):
        ...
        self.assertEqual(
            self.env["account.fiscal.position"].get_fiscal_position(
                partner_be_vat.id, partner_nl_vat.id
            ),
            fp_be_nat,
        )
        ...
        self.assertEqual(
            self.env["account.fiscal.position"].get_fiscal_position(
                partner_nl_vat.id, partner_be_vat.id
            ),
            fp_be_nat,
        )
        ...
        self.assertEqual(
            self.env["account.fiscal.position"].get_fiscal_position(
                partner_be_vat.id, partner_nl_no_vat.id
            ),
            fp_be_nat,
        )
        ...
        self.assertEqual(
            self.env["account.fiscal.position"].get_fiscal_position(
                partner_nl_vat.id, partner_nl_vat.id
            ),
            fp_eu_intra,
        )
        ...
        self.assertEqual(
            self.env["account.fiscal.position"].get_fiscal_position(
                partner_nl_no_vat.id, partner_nl_no_vat.id
            ),
            fp_eu_priv,
        )
        ...
        self.assertEqual(
            self.env["account.fiscal.position"].get_fiscal_position(
                partner_us_no_vat.id, partner_us_no_vat.id
            ),
            fp_eu_extra,
        )
