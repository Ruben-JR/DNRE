...
class TestAccountInvoiceRounding(AccountTestInvoicingCommon):
    ...
    def test_payment_term(self):
        ...
        self.assertPaymentTerm(
            self.pay_term_min_31days_15th, "2019-01-01", ["2019-02-15"]
        )
        self.assertPaymentTerm(
            self.pay_term_min_31days_15th, "2019-01-15", ["2019-02-15"]
        )
        self.assertPaymentTerm(
            self.pay_term_min_31days_15th, "2019-01-31", ["2019-03-15"]
        )
        self.assertPaymentTerm(
