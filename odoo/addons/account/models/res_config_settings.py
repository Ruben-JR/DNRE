...
class ResConfigSettings(models.TransientModel):
    ...
    account_journal_suspense_account_id = fields.Many2one(
        ...
        domain=lambda self: "[('deprecated', '=', False), ('company_id', '=', company_id), ('user_type_id.type', 'not in', ('receivable', 'payable')), ('user_type_id', '=', %s)]"
    ...
    module_l10n_fr_fec_import = fields.Boolean(
        "Import FEC files",
