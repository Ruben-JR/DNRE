...
class Channel(models.Model):
    ...
    def _compute_product_sale_revenues(self):
        ...
        rg_data = {
            ...
            for item in self.env["sale.report"].read_group(
    ...
    def _synchronize_product_publish(self):
        ...
        self.filtered(
            lambda channel: not channel.is_published and channel.product_id.is_published
        ).sudo().product_id.write({"is_published": False})
    ...
    def _filter_add_members(self, target_partners, **member_values):
        ...
        result = super()._filter_add_members(target_partners, **member_values)
