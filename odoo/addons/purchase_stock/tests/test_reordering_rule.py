...
class TestReorderingRule(TransactionCase):
    ...
    def test_reordering_rule_1(self):
        ...
        self.assertEqual(
            purchase_order.picking_ids.move_lines.filtered(
        ...
        self.assertEqual(
            next_picking[0]
            .move_lines.filtered(lambda m: m.product_id == self.product_01)
            .product_qty,
            10,
        )
        self.assertEqual(
    ...
    def test_reordering_rule_2(self):
        ...
        self.assertEqual(
            purchase_order.picking_ids.move_lines[-1].location_dest_id,
    ...
    def test_replenish_report_1(self):
        ...
        with picking_form.move_ids_without_package.new() as move:
            ...
            move.product_uom_qty = 10.0
        customer_picking = picking_form.save()
        customer_picking.move_lines.filtered(
