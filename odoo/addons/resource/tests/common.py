...
class TestResourceCommon(TransactionCase):
    ...
    def setUp(self):
        ...
        self.calendar_jean = self._define_calendar(
            "40 Hours", [(8, 16, i) for i in range(5)], "Europe/Brussels"
        )
        # UTC+6
        self.calendar_patel = self._define_calendar(
            "38 Hours",
            sum([((9, 12, i), (13, 17, i)) for i in range(5)], ()),
            "Etc/GMT-6",
        )
        # UTC-8 winter, UTC-7 summer
        self.calendar_john = self._define_calendar(
            "8+12 Hours", [(8, 16, 1), (8, 13, 4), (16, 23, 4)], "America/Los_Angeles"
        )
        # UTC+1 winter, UTC+2 summer
        self.calendar_jules = self._define_calendar_2_weeks(
        ...
        self.calendar_paul = self._define_calendar(
