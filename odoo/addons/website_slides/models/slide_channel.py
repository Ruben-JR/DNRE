...
class Channel(models.Model):
    ...
    completed_template_id = fields.Many2one(
        "mail.template",
        string="Completion Email",
        help="Email attendees once they've finished the course",
        default=lambda self: self.env["ir.model.data"]._xmlid_to_res_id(
    ...
    def _compute_website_url(self):
        ...
        for channel in self:
            if (
                ...
                channel.website_url = "{}/slides/{}".format(base_url, slug(channel))
    ...
    def _action_add_members(self, target_partners, **member_values):
        ...
        if to_join:
            ...
            existing_map = {cid: list() for cid in self.ids}
