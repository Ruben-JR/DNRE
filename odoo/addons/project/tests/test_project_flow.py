...
class TestProjectFlow(TestProjectCommon, MockEmail):
    ...
    def test_task_process_without_stage(self):
        ...
        self.assertEqual(
            task.project_id.id, self.project_pigs.id, "project_task: incorrect project"
        )
        self.assertEqual(
    ...
    def test_task_process_with_stages(self):
        ...
        self.assertEqual(
            task.project_id.id, self.project_goats.id, "project_task: incorrect project"
        )
        self.assertEqual(
            task.stage_id.sequence,
            1,
