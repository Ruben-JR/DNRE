        ...
        self.user_employee = self.env["res.users"].create(
            {
                ...
                "groups_id": [
                    (6, 0, [self.ref("hr_timesheet.group_hr_timesheet_user")])
                ],
            }
        )
        ...
        self.user_manager = self.env["res.users"].create(
            {
                ...
                "groups_id": [
                    (6, 0, [self.ref("hr_timesheet.group_timesheet_manager")])
                ],
            }
        )
        # employees
...
class TestTimesheet(TestCommonTimesheet):
    ...
    def test_transfert_project(self):
        ...
        self.assertEqual(
            len(self.task1.timesheet_ids), 1, "The timesheet should be linked to task 1"
        )
        ...
        self.assertEqual(
            ...
            1,
            "The timesheet still should be linked to task 1",
        )
