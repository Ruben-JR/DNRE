...
class Applicant(models.Model):
    ...
    def _compute_application_count(self):
        ...
        for applicant in applicants:
            applicant.application_count = (
                application_data_mapped.get(applicant.email_from, 1) - 1
            )
    ...
    def _notify_get_reply_to(
        ...
        if leftover:
            res.update(
                super(Applicant, leftover)._notify_get_reply_to(
        ...
        for applicant in self:
            ...
            if applicant.partner_name or contact_name:
                employee_data = {
                    ...
                    "default_address_id": applicant.company_id
                    and applicant.company_id.partner_id
                    and applicant.company_id.partner_id.id
                    or False,
                    "default_work_email": applicant.department_id
