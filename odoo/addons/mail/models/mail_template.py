...
class MailTemplate(models.Model):
    ...
    body_html = fields.Html(
        "Body", render_engine="qweb", translate=True, sanitize=False
    )
    ...
    scheduled_date = fields.Char(
        "Scheduled Date",
        help="If set, the queue manager will send the email after the date. If not set, the email will be send as soon as possible. You can use dynamic expressions expression.",
    )
