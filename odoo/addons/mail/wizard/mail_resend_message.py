    ...
    def resend_mail_action(self):
        ...
        for wizard in self:
            ...
            if to_send:
                ...
                email_partners_data = []
                for pid, active, pshare, notif, groups in self.env[
                    "mail.followers"
                ]._get_recipient_data(None, "comment", False, pids=to_send.ids):
