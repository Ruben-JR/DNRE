...
class TestChannelInternals(MailCommon):
    ...
    def test_01_join_call(self):
        ...
        channel_partner = channel.sudo().channel_last_seen_partner_ids.filtered(
    ...
    def test_10_start_call_in_chat_should_invite_all_members_to_call(self):
                ...
                },
                {
                    ...
                    "payload": {
                        ...
                        "invitedPartners": [
                            (
                                "insert",
                                [{"id": test_user.partner_id.id, "name": "Test User"}],
                            )
                        ],
                    },
                },
        ...
        self.assertEqual(
            res["invitedPartners"],
            [("insert", [{"id": test_user.partner_id.id, "name": "Test User"}])],
        )
            ...
            [
                ...
                },
                {
                    ...
                    "payload": {
                        "id": channel.id,
                        "invitedGuests": [
                            ("insert", [{"id": test_guest.id, "name": "Test Guest"}])
                        ],
                        "invitedPartners": [
                            (
                                "insert",
    ...
    def test_20_join_call_should_cancel_pending_invitations(self):
        ...
        channel_partner_test_user = (
            channel.sudo().channel_last_seen_partner_ids.filtered(
                lambda channel_partner: channel_partner.partner_id
            ...
            [
                ...
                },
                {
                    ...
                    "payload": {
                        "id": channel.id,
                        "invitedPartners": [
                            ("insert-and-unlink", [{"id": test_user.partner_id.id}])
                        ],
                    },
                },
                {
        ...
        channel_partner_test_guest = (
            channel.sudo().channel_last_seen_partner_ids.filtered(
                lambda channel_partner: channel_partner.guest_id == test_guest
            )
        )
        self.env["bus.bus"].sudo().search([]).unlink()
        with self.assertBus(
            ...
            [
                ...
                },
                {
                    ...
                    "payload": {
                        "id": channel.id,
                        "invitedGuests": [
                            ("insert-and-unlink", [{"id": test_guest.id}])
                        ],
                    },
                },
                {
    ...
    def test_50_garbage_collect_should_remove_old_sessions_and_notify_data(self):
        ...
        channel_partner.rtc_session_ids._write(
    ...
    def test_60_rtc_sync_sessions_should_gc_and_return_outdated_and_active_sessions(
        ...
        test_session = (
            ...
            .sudo()
            .create({"channel_partner_id": test_channel_partner.id})
        )
        test_session.flush()
        test_session._write(
            {"write_date": fields.Datetime.now() - relativedelta(days=2)}
        ...
        with self.assertBus(
            ...
            ) = channel_partner._rtc_sync_sessions(
