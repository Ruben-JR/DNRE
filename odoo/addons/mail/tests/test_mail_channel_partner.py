...
class TestMailChannelMembers(MailCommon):
    ...
    def setUpClass(cls):
        ...
        (
            cls.private_channel | cls.group_channel | cls.public_channel
        ).channel_last_seen_partner_ids.unlink()
    ...
    def test_channel_private_01(self):
        ...
        self.private_channel.with_user(self.user_1).sudo().add_members(
        ...
        with self.assertRaises(AccessError):
            self.private_channel.with_user(self.user_2).add_members(
        ...
        channel_partner_1 = self.env["mail.channel.partner"].search(
            [
                ("channel_id", "=", self.private_channel.id),
    ...
    def test_channel_private_members(self):
        ...
        self.assertEqual(
            channel_partners.mapped("partner_id"),
        ...
        channel_partner_3 = self.env["mail.channel.partner"].search(
            [
                ("channel_id", "=", self.private_channel.id),
                ("partner_id", "=", self.user_portal.partner_id.id),
            ]
    ...
    def test_channel_private_invite(self):
        ...
        self.private_channel.with_user(self.user_1).add_members(
            self.user_portal.partner_id.ids
        )
        channel_partners = self.env["mail.channel.partner"].search(
            [("channel_id", "=", self.private_channel.id)]
    ...
    def test_channel_private_leave(self):
        ...
        self.private_channel.with_user(self.user_portal).sudo().add_members(
            self.user_portal.partner_id.ids
        )
        channel_partners = self.env["mail.channel.partner"].search(
            [("channel_id", "=", self.private_channel.id)]
    ...
    def test_channel_group(self):
        ...
        self.group_channel.with_user(self.user_1).add_members(
            self.user_1.partner_id.ids
        )
        channel_partners = self.env["mail.channel.partner"].search(
            [("channel_id", "=", self.group_channel.id)]
        ...
        with self.assertRaises(AccessError):
            self.group_channel.with_user(self.user_portal).add_members(
                self.user_portal.partner_id.ids
            )
