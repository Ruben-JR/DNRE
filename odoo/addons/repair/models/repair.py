...
class Repair(models.Model):
    ...
    name = fields.Char(
        "Repair Reference", default="New", copy=False, required=True, readonly=True
    )
...
class RepairLine(models.Model):
    ...
    price_subtotal = fields.Float(
        "Subtotal", compute="_compute_price_subtotal", store=True, digits=0
    )
    price_total = fields.Float(
        "Total", compute="_compute_price_total", compute_sudo=True, digits=0
    )
