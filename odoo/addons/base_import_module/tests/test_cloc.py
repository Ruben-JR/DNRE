...
class TestClocFields(test_cloc.TestClocCustomization):
    def test_fields_from_import_module(self):
        ...
        cl.count_customization(self.env)
        self.assertEqual(
            cl.code.get("base", 0), 0, "Don't count fields from standard module"
        )
    ...
    def test_count_qweb_imported_module(self):
        ...
        self.create_xml_id(
            "qweb_view_test", "ir.ui.view", qweb_view.id, "test_imported_module"
        )
        ...
        self.create_xml_id(
            "form_view_test", "ir.ui.view", form_view.id, "test_imported_module"
        )
