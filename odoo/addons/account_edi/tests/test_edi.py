...
from odoo.addons.account_edi.tests.common import (
    AccountEdiTestCommon,
    _mocked_post_two_steps,
    _generate_mocked_needs_web_services,
    _mocked_cancel_failed,
    _generate_mocked_support_batching,
)
...
class TestAccountEdi(AccountEdiTestCommon, CronMixinCase):
    ...
    def test_edi_flow_two_steps(self):
        with self.mock_edi(
            _post_invoice_edi_method=_mocked_post_two_steps,
    ...
    def test_batches(self):
        ...
        with self.mock_edi(
            _get_batch_key_method=_get_batch_key_method,
    ...
    def test_cron_self_trigger(self):
        ...
        with self.capture_triggers(
            ...
            self.assertEqual(
                len(capt.records),
                2,
                "Not all records have been processed in this run, the cron should "
