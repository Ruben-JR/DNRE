...
class AccountEdiTestCommon(AccountTestInvoicingCommon):
    ...
    def mock_edi(
        ...
        try:
            with patch(
                "odoo.addons.account_edi.models.account_edi_format.AccountEdiFormat._is_required_for_invoice",
                new=_is_required_for_invoice_method,
            ), patch(
                "odoo.addons.account_edi.models.account_edi_format.AccountEdiFormat._is_required_for_payment",
                ...
                "odoo.addons.account_edi.models.account_edi_format.AccountEdiFormat._support_batching",
                new=_support_batching_method,
            ), patch(
                "odoo.addons.account_edi.models.account_edi_format.AccountEdiFormat._get_batch_key",
                ...
                "odoo.addons.account_edi.models.account_edi_format.AccountEdiFormat._post_invoice_edi",
                new=_post_invoice_edi_method,
            ), patch(
                "odoo.addons.account_edi.models.account_edi_format.AccountEdiFormat._cancel_invoice_edi",
                new=_cancel_invoice_edi_method,
            ), patch(
                "odoo.addons.account_edi.models.account_edi_format.AccountEdiFormat._post_payment_edi",
                new=_post_payment_edi_method,
            ), patch(
                "odoo.addons.account_edi.models.account_edi_format.AccountEdiFormat._cancel_payment_edi",
